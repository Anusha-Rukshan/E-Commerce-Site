...
<body bgcolor="#000000">
	...
	<form action="insert_product.php" method="post" enctype="multipart/form-data">
		...
		<table align="center" width="600" border="2" bgcolor="#9E9E9E">
...
<?php
	...
	if(isset($_POST['insert_post'])){
		...
		$insert_product = "insert into products(product_cat,product_brand,product_title,product_image,product_price,product_keywords) values ('$product_cat','$product_brand','$product_title','$product_image','$product_price','$product_keywords')";
