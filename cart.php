		...
		<div class="content_wrapper">
			...
			<div id="content_area">
				...
				<div id="shopping_cart">
					...
					Welcome! <b style="color: #679EE0">Shopping Cart -</b>Total Items: <?php total_items(); ?> Total Price: <?php total_price(); ?> <a href="cart.php" style="color: "#679EE0">Back to shopping</a>
...
function updatecart(){
	...
	//sending no error,bcoz the same updatecart function
